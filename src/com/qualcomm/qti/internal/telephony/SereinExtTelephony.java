...
public class SereinExtTelephony extends IExtTelephony.Stub {
    ...
    private static SereinExtTelephony sInstance;
    ...
    private SereinExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
